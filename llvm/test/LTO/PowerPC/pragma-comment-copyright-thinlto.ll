...
; CHECK-TU2-IMPORTED: @[[TU2_STR:__loadtime_comment_str_[0-9a-f]+]] = weak_odr hidden unnamed_addr constant [19 x i8] c"@(#) Copyright TU2\00", section "__loadtime_comment", align 1, !guid ![[#]]
; CHECK-TU2-IMPORTED-NEXT: @[[TU1_STR:__loadtime_comment_str_[0-9a-f]+]] = available_externally hidden unnamed_addr constant [19 x i8] c"@(#) Copyright TU1\00", section "__loadtime_comment", align 1, !guid ![[#]]
