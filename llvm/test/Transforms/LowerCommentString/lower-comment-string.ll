...
!1 = !{!"@(#) Copyright String 2025"}

; ---- Globals --------------------------------------------
; CHECK: @[[LOADTIME_COMMENT_STR:__loadtime_comment_str_[0-9a-f]+]] = weak_odr hidden unnamed_addr constant [27 x i8] c"@(#) Copyright String 2025\00", section "__loadtime_comment", align 1, !guid ![[#]]
