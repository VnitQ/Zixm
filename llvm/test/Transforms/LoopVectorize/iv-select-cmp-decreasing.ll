...
; IC1VF4-NEXT:    [[TMP7:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD]], splat (i64 3)
; IC1VF4-NEXT:    [[TMP3:%.*]] = shufflevector <4 x i1> [[TMP7]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC4VF4-NEXT:    [[TMP19:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD]], splat (i64 3)
; IC4VF4-NEXT:    [[TMP7:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD4]], splat (i64 3)
; IC4VF4-NEXT:    [[TMP20:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD6]], splat (i64 3)
; IC4VF4-NEXT:    [[TMP21:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD8]], splat (i64 3)
; IC4VF4-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i1> [[TMP19]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP10:%.*]] = shufflevector <4 x i1> [[TMP7]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP11:%.*]] = shufflevector <4 x i1> [[TMP20]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP12:%.*]] = shufflevector <4 x i1> [[TMP21]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC1VF4-NEXT:    [[TMP8:%.*]] = icmp ugt <4 x i16> [[WIDE_LOAD]], [[BROADCAST_SPLAT]]
; IC1VF4-NEXT:    [[TMP3:%.*]] = shufflevector <4 x i1> [[TMP8]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC1VF4-NEXT:    [[TMP8:%.*]] = fcmp ugt <4 x half> [[WIDE_LOAD]], [[BROADCAST_SPLAT]]
; IC1VF4-NEXT:    [[TMP3:%.*]] = shufflevector <4 x i1> [[TMP8]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC1VF4-NEXT:    [[TMP4:%.*]] = add nsw <4 x i16> [[VEC_IND]], splat (i16 -1)
; IC1VF4-NEXT:    [[TMP5]] = select <4 x i1> [[TMP3]], <4 x i16> [[TMP4]], <4 x i16> [[VEC_PHI]]
; IC1VF4-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 4
...
; IC1VF4-NEXT:    [[TMP6:%.*]] = icmp sgt <4 x i8> [[WIDE_LOAD]], [[WIDE_LOAD1]]
; IC1VF4-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i1> [[TMP6]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC4VF4-NEXT:    [[TMP15:%.*]] = icmp sgt <4 x i8> [[WIDE_LOAD]], [[WIDE_LOAD10]]
; IC4VF4-NEXT:    [[TMP19:%.*]] = icmp sgt <4 x i8> [[WIDE_LOAD4]], [[WIDE_LOAD11]]
; IC4VF4-NEXT:    [[TMP17:%.*]] = icmp sgt <4 x i8> [[WIDE_LOAD5]], [[WIDE_LOAD12]]
; IC4VF4-NEXT:    [[TMP21:%.*]] = icmp sgt <4 x i8> [[WIDE_LOAD6]], [[WIDE_LOAD13]]
; IC4VF4-NEXT:    [[TMP23:%.*]] = shufflevector <4 x i1> [[TMP15]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP24:%.*]] = shufflevector <4 x i1> [[TMP19]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP25:%.*]] = shufflevector <4 x i1> [[TMP17]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP26:%.*]] = shufflevector <4 x i1> [[TMP21]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC1VF4-NEXT:    [[TMP18:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD]], [[WIDE_LOAD3]]
; IC1VF4-NEXT:    [[TMP11:%.*]] = shufflevector <4 x i1> [[TMP18]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
; IC4VF4-NEXT:    [[TMP23:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD]], [[WIDE_LOAD14]]
; IC4VF4-NEXT:    [[TMP17:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD8]], [[WIDE_LOAD15]]
; IC4VF4-NEXT:    [[TMP18:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD9]], [[WIDE_LOAD16]]
; IC4VF4-NEXT:    [[TMP24:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD10]], [[WIDE_LOAD17]]
; IC4VF4-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i1> [[TMP23]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP29:%.*]] = shufflevector <4 x i1> [[TMP17]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP20:%.*]] = shufflevector <4 x i1> [[TMP18]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i1> [[TMP24]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
