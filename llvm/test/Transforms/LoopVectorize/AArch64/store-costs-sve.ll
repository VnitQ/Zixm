...
; PRED-NEXT:    [[TMP8:%.*]] = extractelement <vscale x 16 x i1> [[ACTIVE_LANE_MASK_NEXT]], i64 0
...
; DEFAULT-NEXT:    [[TMP8:%.*]] = load i64, ptr [[SRC]], align 8, !alias.scope [[META6:![0-9]+]]
; DEFAULT-NEXT:    [[TMP15:%.*]] = trunc i64 [[TMP8]] to i8
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT2:%.*]] = insertelement <vscale x 16 x i8> poison, i8 [[TMP15]], i64 0
...
; DEFAULT-NEXT:    [[TMP5:%.*]] = extractelement <vscale x 16 x i16> [[BROADCAST_SPLAT]], i64 0
; DEFAULT-NEXT:    [[TMP19:%.*]] = trunc i16 [[TMP5]] to i8
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT5:%.*]] = insertelement <vscale x 16 x i8> poison, i8 [[TMP19]], i64 0
...
; DEFAULT-NEXT:    [[TMP20:%.*]] = load i64, ptr [[SRC]], align 8, !alias.scope [[META13:![0-9]+]]
; DEFAULT-NEXT:    [[TMP21:%.*]] = trunc i64 [[TMP20]] to i8
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT8:%.*]] = insertelement <8 x i8> poison, i8 [[TMP21]], i64 0
; DEFAULT-NEXT:    [[TMP9:%.*]] = shufflevector <8 x i8> [[BROADCAST_SPLATINSERT8]], <8 x i8> poison, <8 x i32> zeroinitializer
; DEFAULT-NEXT:    [[TMP22:%.*]] = extractelement <8 x i16> [[BROADCAST_SPLAT5]], i64 0
; DEFAULT-NEXT:    [[TMP23:%.*]] = trunc i16 [[TMP22]] to i8
...
; PRED-NEXT:    [[TMP4:%.*]] = extractelement <vscale x 16 x i16> [[BROADCAST_SPLAT]], i64 0
...
; PRED-NEXT:    [[TMP7:%.*]] = extractelement <vscale x 16 x i1> [[ACTIVE_LANE_MASK_NEXT]], i64 0
