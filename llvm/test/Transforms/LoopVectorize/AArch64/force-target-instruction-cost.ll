...
; RUN: opt -p loop-vectorize -force-target-instruction-cost=1 -force-target-instruction-cost=1 -S %s | FileCheck --check-prefixes=COMMON,COST1 %s
...
; COST1-NEXT:    br i1 [[TMP1]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; COST1:       [[MIDDLE_BLOCK]]:
...
; COST1-NEXT:    br i1 [[TMP4]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
...
; COST10-NEXT:    br i1 [[TMP0]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; COST10:       [[MIDDLE_BLOCK]]:
...
; COST10-NEXT:    br i1 [[TMP3]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
...
; COMMON-NEXT:    [[TMP8:%.*]] = extractelement <2 x i1> [[TMP7]], i64 0
...
; COMMON-NEXT:    [[TMP9:%.*]] = extractelement <2 x i1> [[TMP7]], i64 1
...
; COMMON-NEXT:    [[TMP12:%.*]] = extractelement <2 x i1> [[TMP10]], i64 1
...
; COMMON-NEXT:    br i1 [[TMP25]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP11:![0-9]+]]
; COMMON:       [[MIDDLE_BLOCK]]:
...
; COST1-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP6]], i64 1
; COST1-NEXT:    [[TMP9:%.*]] = extractelement <4 x i64> [[TMP6]], i64 2
; COST1-NEXT:    [[TMP10:%.*]] = extractelement <4 x i64> [[TMP6]], i64 3
...
; COST10-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP3]], i64 1
; COST10-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP3]], i64 2
; COST10-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP3]], i64 3
...
define void @force_branch_cost(ptr readonly %src, ptr %dst) {
; COST1-LABEL: define void @force_branch_cost(
; COST1-SAME: ptr readonly [[SRC:%.*]], ptr [[DST:%.*]]) {
; COST1-NEXT:  [[ENTRY:.*:]]
; COST1-NEXT:    br label %[[VECTOR_MEMCHECK:.*]]
; COST1:       [[VECTOR_MEMCHECK]]:
; COST1-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[DST]], i64 2092
; COST1-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[SRC]], i64 85
; COST1-NEXT:    [[BOUND0:%.*]] = icmp ult ptr [[DST]], [[SCEVGEP1]]
; COST1-NEXT:    [[BOUND1:%.*]] = icmp ult ptr [[SRC]], [[SCEVGEP]]
; COST1-NEXT:    [[FOUND_CONFLICT:%.*]] = and i1 [[BOUND0]], [[BOUND1]]
; COST1-NEXT:    br i1 [[FOUND_CONFLICT]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; COST1:       [[VECTOR_PH]]:
; COST1-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[DST]], i64 1536
; COST1-NEXT:    br label %[[VECTOR_BODY:.*]]
; COST1:       [[VECTOR_BODY]]:
; COST1-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; COST1-NEXT:    [[TMP13:%.*]] = add i64 [[OFFSET_IDX]], 384
...
; COST1-NEXT:    [[NEXT_GEP5:%.*]] = getelementptr i8, ptr [[DST]], i64 [[TMP13]]
...
; COST1-NEXT:    [[TMP54:%.*]] = getelementptr i8, ptr [[NEXT_GEP4]], i64 24
; COST1-NEXT:    [[TMP55:%.*]] = getelementptr i8, ptr [[NEXT_GEP5]], i64 24
...
; COST1-NEXT:    [[TMP62:%.*]] = getelementptr i8, ptr [[NEXT_GEP4]], i64 48
; COST1-NEXT:    [[TMP63:%.*]] = getelementptr i8, ptr [[NEXT_GEP5]], i64 48
...
; COST1-NEXT:    [[TMP70:%.*]] = getelementptr i8, ptr [[NEXT_GEP4]], i64 72
; COST1-NEXT:    [[TMP71:%.*]] = getelementptr i8, ptr [[NEXT_GEP5]], i64 72
...
; COST1:       [[SCALAR_PH]]:
;
; COST10-LABEL: define void @force_branch_cost(
; COST10-SAME: ptr readonly [[SRC:%.*]], ptr [[DST:%.*]]) {
; COST10-NEXT:  [[ENTRY:.*:]]
; COST10-NEXT:    br label %[[VECTOR_MEMCHECK:.*]]
; COST10:       [[VECTOR_MEMCHECK]]:
; COST10-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[DST]], i64 2092
; COST10-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[SRC]], i64 85
; COST10-NEXT:    [[BOUND0:%.*]] = icmp ult ptr [[DST]], [[SCEVGEP1]]
; COST10-NEXT:    [[BOUND1:%.*]] = icmp ult ptr [[SRC]], [[SCEVGEP]]
; COST10-NEXT:    [[FOUND_CONFLICT:%.*]] = and i1 [[BOUND0]], [[BOUND1]]
; COST10-NEXT:    br i1 [[FOUND_CONFLICT]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; COST10:       [[VECTOR_PH]]:
; COST10-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[DST]], i64 1920
; COST10-NEXT:    br label %[[VECTOR_BODY:.*]]
; COST10:       [[VECTOR_BODY]]:
; COST10-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
loop:
  ...
  %gep = getelementptr [4 x i8], ptr %src, i64 %iv
  %val8 = load i8, ptr %gep, align 1
  %val32 = zext i8 %val8 to i32
  store i32 %val32, ptr %ptr, align 4
  %p1 = getelementptr i8, ptr %ptr, i64 24
  store i32 %val32, ptr %p1, align 4
  %p2 = getelementptr i8, ptr %ptr, i64 48
  store i32 %val32, ptr %p2, align 4
  %p3 = getelementptr i8, ptr %ptr, i64 72
  store i32 %val32, ptr %p3, align 4
  %ptr.next = getelementptr i8, ptr %ptr, i64 96
  %iv.next = add nuw nsw i64 %iv, 1
  %done = icmp eq i64 %iv.next, 22
