...
; VSCALEFORTUNING2-NEXT:    [[TMP15:%.*]] = and i32 [[TMP16]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP12:%.*]] = xor i32 [[TMP15]], 1
; VSCALEFORTUNING2-NEXT:    [[TMP13:%.*]] = zext i32 [[TMP12]] to i64
; VSCALEFORTUNING2-NEXT:    [[TMP14:%.*]] = getelementptr i32, ptr [[SRC_2]], i64 [[TMP13]]
; VSCALEFORTUNING2-NEXT:    [[BROADCAST_SPLATINSERT7:%.*]] = insertelement <vscale x 4 x ptr> poison, ptr [[TMP14]], i64 0
; VSCALEFORTUNING2-NEXT:    [[DOTSPLAT:%.*]] = shufflevector <vscale x 4 x ptr> [[BROADCAST_SPLATINSERT7]], <vscale x 4 x ptr> poison, <vscale x 4 x i32> zeroinitializer
...
; PRED-NEXT:    [[TMP9:%.*]] = and i32 [[TMP20]], 1
; PRED-NEXT:    [[TMP10:%.*]] = xor i32 [[TMP9]], 1
; PRED-NEXT:    [[TMP16:%.*]] = zext i32 [[TMP10]] to i64
; PRED-NEXT:    [[TMP17:%.*]] = getelementptr i32, ptr [[SRC_2]], i64 [[TMP16]]
; PRED-NEXT:    [[BROADCAST_SPLATINSERT6:%.*]] = insertelement <vscale x 4 x ptr> poison, ptr [[TMP17]], i64 0
; PRED-NEXT:    [[DOTSPLAT:%.*]] = shufflevector <vscale x 4 x ptr> [[BROADCAST_SPLATINSERT6]], <vscale x 4 x ptr> poison, <vscale x 4 x i32> zeroinitializer
