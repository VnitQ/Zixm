...
; CHECK-NEXT:    [[TMP15:%.*]] = icmp sgt <vscale x 4 x i64> [[VP_OP_LOAD]], [[VP_OP_LOAD4]]
; CHECK-NEXT:    [[TMP16:%.*]] = call <vscale x 4 x i1> @llvm.experimental.vp.reverse.nxv4i1(<vscale x 4 x i1> [[TMP15]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP4]])
