...
; CHECK-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: v_fptrunc_round_f32_to_f16_towardzero:
; GFX12:       ; %bb.0:
...
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-NEXT:    v_cvt_f16_f32_e32 v4, v1
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-NEXT:    v_cvt_f16_f32_e32 v4, v0
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 2
; GFX12-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 3, 1), 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_f16_e32 v0, v4, v0
; GFX12-NEXT:    v_add_f16_e32 v0, v1, v0
; GFX12-NEXT:    global_store_b16 v[2:3], v0, off
; GFX12-NEXT:    s_endpgm
  %res1 = call half @llvm.fptrunc.round.f16.f32(float %a, metadata !"round.upward")
...
; CHECK-NEXT:    s_endpgm
;
; GFX12-LABEL: v_fptrunc_round_f32_to_f16_towardzero_multiple_calls:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 3
; GFX12-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-NEXT:    v_cvt_f16_f32_e32 v4, v1
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 1
; GFX12-NEXT:    v_cvt_f16_f32_e32 v1, v1
...
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
...
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v6, v2
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v7, v3
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 2
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v2
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v2, v3
; GFX12-SDAG-NEXT:    v_perm_b32 v3, v7, v6, 0x5040100
; GFX12-SDAG-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
...
; GFX12-SDAG-NEXT:    v_pk_add_f16 v0, v0, v3
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v6, v2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v7, v3
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v2, v3
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v3, v6, v7
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v1, v1, v2
...
; GFX12-GISEL-NEXT:    v_pk_add_f16 v0, v0, v3
; GFX12-GISEL-NEXT:    v_pk_add_f16 v0, v1, v0
...
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_lshl_or_b32 v1, s0, 16, v2
; GFX12-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v3, v3
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12-SDAG-NEXT:    v_perm_b32 v1, v3, v2, 0x5040100
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v3, v3
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v1, v2, v3
; GFX12-GISEL-NEXT:    ; return to shader part epilog
...
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v6, v6
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v4, v4
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v3, v3
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v5, v5
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e32 v7, v7
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-SDAG-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12-SDAG-NEXT:    v_perm_b32 v1, v3, v2, 0x5040100
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-SDAG-NEXT:    v_perm_b32 v2, v5, v4, 0x5040100
; GFX12-SDAG-NEXT:    v_perm_b32 v3, v7, v6, 0x5040100
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v3, v3
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v4, v4
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v5, v5
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v6, v6
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e32 v7, v7
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v1, v2, v3
; GFX12-GISEL-NEXT:    v_pack_b32_f16 v2, v4, v5
...
; CHECK-LABEL: s_fptrunc_round_f64_to_f32_upward:
; CHECK:       ; %bb.0:
...
; CHECK-LABEL: s_fptrunc_round_f64_to_f32_downward:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    v_mov_b32_e32 v0, s0
; CHECK-NEXT:    v_mov_b32_e32 v1, s1
; CHECK-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 3, 1), 1
