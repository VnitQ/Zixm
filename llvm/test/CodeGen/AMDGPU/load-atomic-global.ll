...
define amdgpu_cs void @atomic_load_f32x2_unordered_agent_align4(ptr addrspace(1) %p, ptr addrspace(1) %out) {
...
; GFX12-NEXT:    global_store_b32 v[2:3], v0, off
; GFX12-NEXT:    s_endpgm
  %a0 = load atomic <2 x float>, ptr addrspace(1) %p syncscope("agent") unordered, align 4
  %num1 = extractelement <2 x float> %a0, i32 0
  %num2 = extractelement <2 x float> %a0, i32 1
  %res = fadd float %num1, %num2
  store float %res, ptr addrspace(1) %out, align 4
...
define amdgpu_cs void @atomic_load_f32x2_monotonic_agent_align4(ptr addrspace(1) %p, ptr addrspace(1) %out) {
...
; GFX12-NEXT:    global_store_b32 v[2:3], v0, off
; GFX12-NEXT:    s_endpgm
  %a0 = load atomic <2 x float>, ptr addrspace(1) %p syncscope("agent") monotonic, align 4
  %num1 = extractelement <2 x float> %a0, i32 0
  %num2 = extractelement <2 x float> %a0, i32 1
  %res = fadd float %num1, %num2
  store float %res, ptr addrspace(1) %out, align 4
