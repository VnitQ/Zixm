...
; GFX8DAGISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX8GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX8GISEL-NEXT:    v_sub_f32_e32 v3, 0, v3
...
; GFX9DAGISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX9GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX9GISEL-NEXT:    v_sub_f32_e32 v3, 0, v3
...
; GFX1064DAGISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX1064GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s[4:5]
...
; GFX1032DAGISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s4
...
; GFX1032GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, v2, s4
...
; GFX12DAGISEL-NEXT:    s_setpc_b64 s[30:31]
entry:
  %result = call float @llvm.amdgcn.wave.reduce.fsub(float %id.x, i32 2)
  store float %result, ptr addrspace(1) %out
  ret void
}
...
; GFX12DAGISEL-NEXT:    s_endpgm
entry:
  %result = call double @llvm.amdgcn.wave.reduce.fsub(double %in, i32 1)
  store double %result, ptr addrspace(1) %out
  ret void
}
...
if:
  %reducedValTid = call double @llvm.amdgcn.wave.reduce.fsub(double %in2, i32 1)
  br label %endif

else:
  %reducedValIn = call double @llvm.amdgcn.wave.reduce.fsub(double %in, i32 1)
  br label %endif
