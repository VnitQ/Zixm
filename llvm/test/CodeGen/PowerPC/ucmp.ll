...
; RUN: llc -mtriple=ppc64le-unknown-unknown %s -o - | FileCheck %s --check-prefix=CHECK
; RUN: llc -mtriple=ppc64le-unknown-unknown -mcpu=pwr9 %s -o - | FileCheck %s --check-prefix=P9
...
; P9-NEXT:    li 3, 1
; P9-NEXT:    li 4, -1
; P9-NEXT:    crandc 20, 1, 2
; P9-NEXT:    crand 21, 2, 5
; P9-NEXT:    crnor 20, 21, 20
; P9-NEXT:    crand 21, 2, 4
; P9-NEXT:    isel 3, 0, 3, 20
; P9-NEXT:    crandc 20, 0, 2
; P9-NEXT:    cror 20, 21, 20
; P9-NEXT:    isel 3, 4, 3, 20
; P9-NEXT:    blr
