...
define i64 @test_v2i64_v2i32(<2 x i64> %a0) nounwind {
...
; X86-SSE2-NEXT:    retl
;
; X64-SSE-LABEL: test_v2i64_v2i32:
; X64-SSE:       # %bb.0:
...
define i64 @test_v4i64_v4i16(<4 x i64> %a0) nounwind {
...
define i64 @test_v8i64_v8i8(<8 x i64> %a0) nounwind {
...
define i64 @test_v16i64_v16i8(<16 x i64> %a0) nounwind {
...
define i32 @test_v16i32_v16i8(<16 x i32> %a0) nounwind {
; X86-SSE2-LABEL: test_v16i32_v16i8:
; X86-SSE2:       # %bb.0:
; X86-SSE2-NEXT:    pushl %ebp
; X86-SSE2-NEXT:    movl %esp, %ebp
; X86-SSE2-NEXT:    andl $-16, %esp
...
define i32 @test_v32i32_v32i8(<32 x i32> %a0) nounwind {
...
;
; X64-AVX1-SLOW-LABEL: test_v32i32_v32i8:
; X64-AVX1-SLOW:       # %bb.0:
; X64-AVX1-SLOW-NEXT:    vbroadcastss {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255]
...
;
; X64-AVX1-FAST-LABEL: test_v32i32_v32i8:
; X64-AVX1-FAST:       # %bb.0:
; X64-AVX1-FAST-NEXT:    vbroadcastss {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255]
...
;
; X86-AVX2-LABEL: test_v32i32_v32i8:
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    pushl %ebp
; X86-AVX2-NEXT:    movl %esp, %ebp
; X86-AVX2-NEXT:    andl $-32, %esp
; X86-AVX2-NEXT:    subl $32, %esp
; X86-AVX2-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
; X86-AVX2-NEXT:    vpand %ymm3, %ymm1, %ymm1
...
; X86-AVX2-NEXT:    retl
;
; X64-AVX2-LABEL: test_v32i32_v32i8:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpbroadcastd {{.*#+}} ymm4 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
; X64-AVX2-NEXT:    vpand %ymm4, %ymm2, %ymm2
; X64-AVX2-NEXT:    vpand %ymm4, %ymm0, %ymm0
...
define i16 @test_v2i16_v2i8(<2 x i16> %a0) nounwind {
...
define i16 @test_v4i16_v4i8(<4 x i16> %a0) nounwind {
; X86-SSE2-LABEL: test_v4i16_v4i8:
; X86-SSE2:       # %bb.0:
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [0,65535,65535,65535,65535,65535,65535,65535]
; X86-SSE2-NEXT:    pandn %xmm0, %xmm1
; X86-SSE2-NEXT:    pmulhuw {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0 # [0,0,0,128,0,64,0,32,u,u,u,u,u,u,u,u]
...
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [0,65535,65535,65535,65535,65535,65535,65535]
; X64-SSE2-NEXT:    pandn %xmm0, %xmm1
; X64-SSE2-NEXT:    pmulhuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0 # [0,0,0,128,0,64,0,32,u,u,u,u,u,u,u,u]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movq {{.*#+}} xmm1 = [0,32768,16384,8192,0,0,0,0]
...
; SSE4-NEXT:    ret{{[l|q]}}
;
; X86-AVX1-SLOW-LABEL: test_v4i16_v4i8:
; X86-AVX1-SLOW:       # %bb.0:
; X86-AVX1-SLOW-NEXT:    vpmulhuw {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0, %xmm1 # [u,32768,16384,8192,u,u,u,u]
; X86-AVX1-SLOW-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm1[1,2,3,4,5,6,7]
; X86-AVX1-SLOW-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
...
; X86-AVX1-SLOW-NEXT:    retl
;
; X64-AVX1-SLOW-LABEL: test_v4i16_v4i8:
; X64-AVX1-SLOW:       # %bb.0:
; X64-AVX1-SLOW-NEXT:    vpmulhuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm1 # [u,32768,16384,8192,u,u,u,u]
; X64-AVX1-SLOW-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm1[1,2,3,4,5,6,7]
; X64-AVX1-SLOW-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
...
; X64-AVX1-SLOW-NEXT:    retq
;
; X86-AVX1-FAST-LABEL: test_v4i16_v4i8:
; X86-AVX1-FAST:       # %bb.0:
...
; X86-AVX1-FAST-NEXT:    retl
;
; X64-AVX1-FAST-LABEL: test_v4i16_v4i8:
; X64-AVX1-FAST:       # %bb.0:
...
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    vpmulhuw {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0, %xmm1 # [u,32768,16384,8192,u,u,u,u]
...
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpmulhuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm1 # [u,32768,16384,8192,u,u,u,u]
...
define i16 @test_v8i16_v8i8(<8 x i16> %a0) nounwind {
...
define i16 @test_v32i16_v32i8(<32 x i16> %a0) nounwind {
...
define i16 @test_v64i16_v64i8(<64 x i16> %a0) nounwind {
