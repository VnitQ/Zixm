...
// CHECK: spir_func noundef ptr @{{.*}}test_cast_to_private{{.*}}(ptr addrspace(4) nofree noundef readnone [[P:%.*]]
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK: spir_func noundef ptr addrspace(1) @{{.*}}test_cast_to_global{{.*}}(ptr addrspace(4) nofree noundef readnone [[P:%.*]]
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK: spir_func noundef ptr addrspace(3) @{{.*}}test_cast_to_local{{.*}}(ptr addrspace(4) nofree noundef readnone [[P:%.*]]
// CHECK-NEXT:  [[ENTRY:.*:]]
