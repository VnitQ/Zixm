...
void Foo::bar() {
  m_obj1->method();
  m_obj2->method();
  // expected-warning@-1{{Call argument 'this->m_obj2' for 'this' parameter of 'CheckedObj::method' is a raw pointer to CheckedPtr capable type 'CheckedObj'}}
}
...
void Foo::bar() {
  ...
  // expected-warning@-1{{Call argument 'this->badEnsureObj4()' for 'this' parameter of 'CheckedObj::method' is a raw pointer to CheckedPtr capable type 'CheckedObj'}}
  ensureObj5()->method();
  ensureObj6()->method();
}
