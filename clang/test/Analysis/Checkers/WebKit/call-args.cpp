...
namespace simple {
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'provide()' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}
  }
...
namespace multi_arg {
  ...
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'provide()' for parameter 'foo' of 'multi_arg::consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}
  }
}
...
namespace methods {
  ...
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'provide()' for parameter 'ptr' of 'methods::Consumer::consume_ptr' is a raw pointer to ref-countable type 'RefCountable'}}
    c.consume_ref(*provide());
    // expected-warning@-1{{Call argument '*provide()' for parameter 'ref' of 'methods::Consumer::consume_ref' is a raw reference to ref-countable type}}
  }
  ...
  void foo2() {
    struct Consumer {
      ...
      void whatever() {
        consume(provide());
        // expected-warning@-1{{Call argument 'provide()' of 'methods::foo2()::Consumer::consume' is a raw pointer to ref-countable type 'RefCountable'}}
      }
    };
  }
  ...
  void foo3() {
    struct Consumer {
      ...
      void whatever() {
        ...
        // expected-warning@-1{{Call argument 'provide()' of 'methods::foo3()::Consumer::consume' is a raw pointer to ref-countable type 'RefCountable'}}
      }
    };
  }
}
...
namespace casts {
  ...
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'static_cast<RefCountable *>(provide())' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}

    consume_refcntbl(dynamic_cast<RefCountable*>(provide()));
    // expected-warning@-1{{Call argument 'dynamic_cast<RefCountable *>(provide())' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}

    consume_refcntbl(const_cast<RefCountable*>(provide()));
    // expected-warning@-1{{Call argument 'const_cast<RefCountable *>(provide())' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}

    consume_refcntbl(reinterpret_cast<RefCountable*>(provide()));
    // expected-warning@-1{{Call argument 'reinterpret_cast<RefCountable *>(provide())' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}

    consume_refcntbl(downcast(provide()));
    // expected-warning@-1{{Call argument 'downcast(provide())' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}
    ...
    // expected-warning@-8{{Call argument 'static_cast<RefCountable *>(downcast(static_cast<R...' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}
  }
}
...
namespace ref_counted_lookalike {
  ...
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'D.get()' of 'consume_refcntbl' is a raw pointer to ref-countable type 'RefCountable'}}
  }
}
...
namespace default_arg {
  ...
  // expected-warning@-1{{Call argument 'global' for parameter 'param' of 'default_arg::function_with_default_arg' is a raw pointer to ref-countable type 'RefCountable'}}
...
namespace cxx_member_func {
  ...
  void foo() {
    provide()->trivial();
    provide()->method();
    // expected-warning@-1{{Call argument 'provide()' for 'this' parameter of 'RefCountable::method' is a raw pointer to ref-countable type 'RefCountable'}}
...
namespace cxx_member_operator_call {
  ...
  void foo12() {
    Foo f;
    f + global;
    // expected-warning@-1{{Call argument 'global' for parameter 'bad' of 'cxx_member_operator_call::Foo::operator+' is a raw pointer to ref-countable type 'RefCountable'}}
    f - global;
    // expected-warning@-1{{Call argument 'global' for parameter 'bad' of 'cxx_member_operator_call::operator-' is a raw pointer to ref-countable type 'RefCountable'}}
    f(global);
    // expected-warning@-1{{Call argument 'global' for parameter 'bad' of 'cxx_member_operator_call::Foo::operator()' is a raw pointer to ref-countable type 'RefCountable'}}
    container()[0] = 3;
    // expected-warning@-1{{Call argument 'container()' for 'this' parameter of 'cxx_member_operator_call::Container::operator[]' is a raw pointer to ref-countable type 'cxx_member_operator_call::Container'}}
  }
}
...
namespace call_function_ptr {
  ...
  void foo(void (*consume)(void*, RefCountableWithWeakPtr*), void (*consumeVar)(RefCountableWithWeakPtr*, ...), void (RefCountableWithWeakPtr::*method)()) {
    ...
    // expected-warning@-1{{Call argument 'provide()' is a raw pointer to ref-countable type 'call_function_ptr::RefCountableWithWeakPtr}}
    consumeVar(nullptr, provide());
    // expected-warning@-1{{Call argument 'provide()' is a raw pointer to ref-countable type 'call_function_ptr::RefCountableWithWeakPtr}}
    (provide()->*method)();
    // expected-warning@-1{{Call argument 'provide()' for 'this' parameter is a raw pointer to ref-countable type 'call_function_ptr::RefCountableWithWeakPtr'}}
  }
...
namespace call_with_ptr_on_ref {
  ...
  void foo(bool v) {
    ...
    // expected-warning@-1{{Call argument 'v ? provide() : provideProtected().ptr()' for parameter 'bad' of 'call_with_ptr_on_ref::bar' is a raw pointer to ref-countable type 'RefCountable'}}
    bar(v ? provideProtected().ptr() : provide());
    // expected-warning@-1{{Call argument 'v ? provideProtected().ptr() : provide()' for parameter 'bad' of 'call_with_ptr_on_ref::bar' is a raw pointer to ref-countable type 'RefCountable'}}
  }
}
...
namespace call_with_explicit_construct {
  ...
  public:
    Obj(RefCountable* obj = provide(), RefCountable* otherObj = nullptr) {
      // expected-warning@-1{{Call argument 'provide()' for parameter 'obj' of 'call_with_explicit_construct::Obj::Obj' is a raw pointer to ref-countable type 'RefCountable'}}
  ...
  void foo(RefCountable* arg) {
    ...
    // expected-warning@-1{{Call argument 'provide()' for parameter 'obj' of 'call_with_explicit_construct::Obj::Obj' is a raw pointer to ref-countable type 'RefCountable'}}
    Obj obj3(*provide());
    // expected-warning@-1{{Call argument '*provide()' for parameter 'obj' of 'call_with_explicit_construct::Obj::Obj' is a raw reference to ref-countable type 'RefCountable'}}
    Obj obj4(Ref<RefCountable> { *provide() }.get());
    Obj obj5(arg);
    Obj obj6(arg, provide());
    // expected-warning@-1{{Call argument 'provide()' for parameter 'otherObj' of 'call_with_explicit_construct::Obj::Obj' is a raw pointer to ref-countable type 'RefCountable'}}
  }
}
...
namespace call_on_member {
  ...
  public:
    ...
    void doWork() {
      m_obj->method();
      // expected-warning@-1{{Call argument 'this->m_obj' for 'this' parameter of 'RefCountable::method' is a raw pointer to ref-countable type 'RefCountable'}}
      m_obj.get()->method();
      // expected-warning@-1{{Call argument 'this->m_obj.get()' for 'this' parameter of 'RefCountable::method' is a raw pointer to ref-countable type 'RefCountable'}}
      m_constObj->method();
    }
  ...
  void foo() {
    ...
    // expected-warning@-1{{Call argument 'provide()->constObj()' for 'this' parameter of 'RefCountable::method' is a raw pointer to ref-countable type 'RefCountable'}}
...
namespace call_with_weak_ptr {
  ...
  void foo() {
    ...
    consume(weakPtr);
    // expected-warning@-1{{Call argument 'weakPtr' of 'call_with_weak_ptr::consume' is a raw pointer to ref-countable type 'call_with_weak_ptr::RefCountableWithWeakPtr'}}
    weakPtr->method();
    // expected-warning@-1{{Call argument 'weakPtr' for 'this' parameter of 'RefCountable::method' is a raw pointer to ref-countable type 'RefCountable'}}
  }
