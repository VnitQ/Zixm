...
void Foo::bar() {
  ...
  [m_obj doWork]; // expected-warning{{Receiver 'this->m_obj' of 'SomeObj::doWork' is a raw pointer to retainable type 'SomeObj'}}
}
...
void Foo::bar() {
  ...
  consume_cf(m_cf2.get()); // expected-warning{{Call argument 'this->m_cf2.get()' of 'consume_cf' is a retainable type 'CFArrayRef'}}
}
...
void Foo::bar() {
  ...
  consume_obj(m_obj.get()); // expected-warning{{Call argument 'this->m_obj.get()' of 'consume_obj' is a retainable type 'WTF::RetainPtr<SomeObj>::PtrType'}}
}
...
void Foo::bar() {
  ...
  consume_obj(m_obj); // expected-warning{{Call argument 'this->m_obj' of 'consume_obj' is a retainable type 'WTF::RetainPtr<SomeObj>::PtrType'}}
}
...
void Foo::bar() {
  consume_obj(m_constObj.get()); // no-warning
  consume_obj(m_obj.get()); // expected-warning{{Call argument 'this->m_obj.get()' of 'consume_obj' is a raw pointer to retainable type 'SomeObj'}}
}
