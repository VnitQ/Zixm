...
// Signed bit field tests: no false positive when bit field width == source type width.
...
// E.g. if size==0, (short)0 - 1 = -1 (0xFFFFFFFF as int), but in 64-bit
// it should be 0xFFFFFFFFFFFFFFFF.
