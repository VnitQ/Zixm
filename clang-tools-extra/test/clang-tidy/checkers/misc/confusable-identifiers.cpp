...
int rn;
int m;
// CHECK-MESSAGES: :[[#@LINE-1]]:5: warning: 'm' is confusable with 'rn' [misc-confusable-identifiers]
// CHECK-MESSAGES: :[[#@LINE-3]]:5: note: other declaration found here

int μ;
int µ;
// CHECK-MESSAGES: :[[#@LINE-1]]:5: warning: 'µ' is confusable with 'μ' [misc-confusable-identifiers]
// CHECK-MESSAGES: :[[#@LINE-3]]:5: note: other declaration found here
